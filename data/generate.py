...
sizes = [5000*x for x in range(1, 21)]
...
for size in sizes:
    ...
    np.savetxt(f'benchmark/random_{size:08d}.txt', np.insert(random_array, 0, size), fmt='%d')
    np.savetxt(f'benchmark/increasing_{size:08d}.txt', np.insert(increasing_array, 0, size), fmt='%d')
    np.savetxt(f'benchmark/decreasing_{size:08d}.txt', np.insert(decreasing_array, 0, size), fmt='%d')
    np.savetxt(f'benchmark/constant_{size:08d}.txt', np.insert(constant_array, 0, size), fmt='%d')
    np.savetxt(f'benchmark/a_shaped_{size:08d}.txt', np.insert(a_shaped_array, 0, size), fmt='%d')
